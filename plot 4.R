...
# Plot 1
plot(days, hpc_data$Global_active_power, type="l", pch=1, ylab = "Global Active Power (Kilowats)", xlab = "Datetime")

# Plot 2
plot(days, hpc_data$Voltage, type="l", pch=1, ylab = "Voltage", xlab = "Datetime")

# Plot 3
plot(days, hpc_data$Sub_metering_1, type="l", pch=1, col="black", ylab = "Energy sub metering", xlab = "Datetime")
...
# Plot 4
plot(days, hpc_data$Global_reactive_power, type="l", pch=1, col="black", ylab = "Energy sub metering", xlab = "Datetime")
